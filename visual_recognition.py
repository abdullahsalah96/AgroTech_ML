...
m = Model(version='2016-05-20', iam_apikey= 'Fs1AI_0z05aKN_nQw5Fw6iEYZ-2TWRv0scLu5vbellgT', classifier_ids='DefaultCustomModel_446412371')
print(datetime.datetime.now().time())
prediction = m.predict('/home/abdullahsalah96/Downloads/Cats_test/kitten-tabby_grey.jpg', 0.6)
print(datetime.datetime.now().time())
